        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center lg:text-left">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="flex flex-col gap-6 reveal reveal-left">
              <div className="flex items-center gap-2 text-primary font-black uppercase tracking-[0.3em] text-[10px] mx-auto lg:mx-0">
              ...
              <p className="text-base md:text-lg text-gray-400 leading-relaxed font-light max-w-lg mx-auto lg:mx-0">
              ...
              <div className="flex flex-wrap gap-4 pt-2 justify-center lg:justify-start">
                <button 
                  ...
                  className="w-fit mx-auto lg:mx-0 bg-primary hover:bg-purple-600 text-white px-8 py-4 rounded-2xl font-display uppercase tracking-tighter text-base md:text-lg transition-all shadow-xl shadow-primary/30 active:scale-95 group flex items-center justify-center gap-3 border border-white/10"
                >
            ...
            <div className="relative reveal reveal-right">
              <div className="relative aspect-video max-w-[480px] mx-auto lg:max-w-none rounded-[3rem] overflow-hidden bg-[#0a0c10]/40 border border-white/5 shadow-[0_0_100px_rgba(0,0,0,0.5)] backdrop-blur-xl flex items-center justify-center ring-1 ring-white/10">
                <AcademicBot isHappy={isHoveringCTA} />
                <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_40%,#101622_110%)]"></div>
              </div>
            </div>
          </div>
        </div>
